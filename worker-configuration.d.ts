/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61dc61322ea05176034d19bcd400ca66)
// Runtime types generated with workerd@1.20260910.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	CLASSROOM_ROOM_DO: DurableObjectNamespace<import("./src/worker").ClassroomRoomDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ClassroomRoomDO";
	}
